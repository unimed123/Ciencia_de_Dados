...
# Data: 08/08/2016 - inicio aula: 6:31pm     27/08/2016 - fim aula: 2:37pm        #
###############################################################################
...
# Armazenamos com numero de dias desde 1 de janeiro de 1970

# Time - representado por POSIXct
# Armazenados como numero de segundos desde 1 de janeiro de 1970

# Formatos de Datas
# %d : dia do mes em dois digitos (13)
# %m : mes com 2 digitos (08)
# %y : ano com 2 digitos (16)
# %Y : ano com 4 digitos (2016)
