...
# Data: 13/09/2016 - inicio aula: 7:15pm     13/09/2016 - fim aula: :pm    #
###############################################################################
...
# Outro aspecto que pode ser mapeado nesse grafico eh a cor dospontos
ggplot(data = mtcars, 
       aes(x = disp, y = mpg, 
           colour = as.factor(am))) + geom_point()

# No entando, tambem podemos mapear uma variavel continua a cor dos pontos:
ggplot(mtcars, 
       aes(x = disp, y = mpg, 
...
# A legenda inserida no grafico automaticamente
...
ggplot(mtcars, aes(x = as.factor(cyl), y = mpg,
                   colour = as.array(cyl))) + geom_boxplot()
...
# Plots diferentes juntos (diferente de Facet) ???? não funcionou####
